"""
Purpose:
1. Queries Springer's API (a publisher of scientific research) using the keyword 'diabetes'
...
url = "http://api.springernature.com/metadata/json?p=100&q=keyword:diabetes&api_key=d8a0b26cff2607963363c0256b43d3d9"
...
def lambda_handler(event, context):
    ...
    df = json_to_df()
    df.to_sql(
        con=engine, schema='SpringerPublications', name="Diabetes",
