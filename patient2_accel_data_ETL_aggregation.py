...
def fetch_accel_data():
    '''
    Fetches patient's accelerometer sensor data.
    '''
    import pandas as pd
    # Connect to S3
    ...
    obj = s3.get_object(Bucket='d1namo', Key='diabetes_subset_sensor_data/002/sensor_data/2014_10_02-06_44_21/2014_10_02-06_44_21_Accel.csv')
...
def aggregate_accel_data():
    ...
    Returns 5-minute aggregated data
    '''
    import pandas as pd
...
def create_join_columns():
    ...
    returns the data frame with additional join columns
    '''
    import pandas as pd
